...
//     if (!user?.id) return;
//     try {
//       // Backend ke stats endpoint se data lena
//       const res = await fetch(`http://127.0.0.1:8001/api/tasks/stats?user_id=${user.id}`);
//       if (res.ok) {
...
//   if (isLoading) return <div className="p-10 text-white animate-pulse">Loading Insights...</div>;

//   return (
//     <div className="p-8 bg-[#0B0E14] min-h-screen text-white">
//       <h1 className="text-4xl font-black italic uppercase mb-2">Insights</h1>
//       <p className="text-gray-500 text-[10px] font-bold uppercase tracking-[0.3em] mb-10">Real-time performance metrics</p>

//       {/* Stats Cards */}
//       <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
//         {[
//           { label: 'Total Tasks', value: stats.totalTasks, color: 'border-purple-500' },
//           { label: 'Completed', value: stats.completed, color: 'border-green-500' },
//           { label: 'Efficiency', value: stats.efficiency, color: 'border-blue-500' },
//           { label: 'Pending', value: stats.pending, color: 'border-pink-500' },
//         ].map((item, i) => (
//           <div key={i} className={`bg-[#161b22] p-6 rounded-3xl border-l-4 ${item.color} shadow-xl`}>
...
//           <h2 className="text-xs font-black uppercase tracking-widest mb-8 text-gray-400">Weekly Activity</h2>
//           <div className="h-64">
...
//                 <YAxis hide />
//                 <Tooltip cursor={{fill: '#ffffff05'}} contentStyle={{backgroundColor: '#0B0E14', border: 'none', borderRadius: '10px'}} />
//                 <Bar dataKey="tasks" fill="#9333ea" radius={[10, 10, 0, 0]} barSize={40} />
//               </BarChart>
//             </ResponsiveContainer>
//           </div>
//         </div>
...
//         {/* Status Distribution */}
//         <div className="bg-[#161b22] p-8 rounded-[2.5rem] border border-white/5 flex flex-col items-center">
//           <h2 className="text-xs font-black uppercase tracking-widest mb-8 text-gray-400 w-full">Task Status Distribution</h2>
...
//             <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-purple-600"></div><span className="text-[10px] font-bold uppercase text-gray-400">Completed</span></div>
//             <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-slate-800"></div><span className="text-[10px] font-bold uppercase text-gray-400">Pending</span></div>
//           </div>
//         </div>
//       </div>
//     </div>
